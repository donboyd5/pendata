...
#'
#' @description Contains mortality improvement rates from Scale MP-2021,
...
#' deterioration).
#'
#' @format A tibble with 17,574 rows and 4 columns:
#' \describe{
#'   \item{gender}{Factor with levels 'male' and 'female' indicating biological sex}
#'   \item{year}{Integer representing calendar year, ranging from 1951 to 2037}
...
#' }
#'
#' @note The scale includes both historical data (1951-20xx) and projected
#' improvements (20yy-2037). Negative values in the 'mp' column indicate
...
#' \url{https://www.soa.org/resources/experience-studies/2021/mortality-improvement-scale-mp-2021/}
#'
#' @examples
