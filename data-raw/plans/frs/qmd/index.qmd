...
- *Outside* of this package, analysts put ALL data for a plan into an Excel file and, following rules laid out elsewhere, and copy that Excel file into the `extracted_data` folder for the plan. For example, the file for FRS is "data-raw\plans\frs\extracted_data\frs_extracted_data_v6.xlsm".
