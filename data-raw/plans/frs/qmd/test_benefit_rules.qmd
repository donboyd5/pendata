...
# source(here::here("data-raw", "R", "setup.R")) # loaded in test_benefit_multiplier.R
...
test_results <- testthat::test_file(
  here::here("data-raw", "plans", "tests/testthat/test_benefit_multiplier.R"),
...
tibble(
  test = "all bemefot rules tests passed",
