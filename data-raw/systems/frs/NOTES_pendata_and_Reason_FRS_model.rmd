...
-   Read male and female tables, create a long data frame (**SOA MP-2018_mortality_improvement_table.R**)

-   Save as an .rda file (**SOA MP-2018_mortality_improvement_table.R**). pendata saves the unadjusted mortality improvement table because other systems may also use mp-2018 and we want a version as provided by SOA for use when developing data for systems other than frs.
