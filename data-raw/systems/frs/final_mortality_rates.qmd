...
Final mortality rates, reflectomg base-year rates plus mortality improvement.
...
# saveRDS(class_mortality_xwalk, path(dfrs, "class_mortality_xwalk.rds")) # maybe we need this?
...
saveRDS(mort_final, fs::path(drds, "mortality_final.rds"))
...
mf <- readRDS(fs::path(drds, "mortality_final.rds"))
