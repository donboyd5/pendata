...
# saveRDS(headcount_table, path(dfrs, "headcount_raw.rds"))


# headcount_grossup -------------------------------------------------------

# headcount does not include DC members, so gross up for that using ratio of
# total headcount to the DB headcount
...
saveRDS(headcount_adjusted, path(dfrs, "headcount.rds"))
